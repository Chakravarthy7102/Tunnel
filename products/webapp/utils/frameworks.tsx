import { CodeSteps } from '#components/v1/get-started/code-steps.tsx';
import { CodeBlock } from '#components/v1/ui/code.tsx';
...
export const frameworkOptions = {
	react: {
				...
				steps={[
					{
						...
						code: (
							<CodeBlock code="npm install -g @tunnel/cli" language="shell" />
						),
					},
					{
						text: 'Add Tunnel to your dev script',
						code: (
							<CodeBlock
								code={`"scripts": {\n	"dev": "tunnel 3000 -- vite dev --port PORT"\n}`}
								language="json"
							/>
						),
					},
		...
		getHostedInstallation: (projectId: string, isCondensed: boolean) => (
			<CodeSteps
				steps={[
					{
						text: 'Install the React SDK',
						code: (
							<CodeBlock code="npm install @tunnel/react" language="shell" />
						),
					},
					{
						text: 'Add the Tunnel Toolbar to your app',
						code: (
							<CodeBlock
								code={`import { TunnelToolbar } from "@tunnel/react";\n\nexport default function App() {\n  return (\n    <>\n      <h1>My App</h1>\n      {process.env.APP_ENV === "staging" && (\n        <TunnelToolbar\n          projectId="${projectId}"\n          branch="BRANCH_NAME"\n        />\n      )}\n    </>\n  );\n}`}
								language="javascript"
								lineNumbers
	...
	next: {
			...
			<CodeSteps
				steps={[
					...
					},
					{
						...
						code: (
							<CodeBlock
								code={`"scripts": {\n	"dev": "tunnel 3000 -- next dev --port PORT"\n}`}
								language="json"
							/>
						),
					},
		...
		getHostedInstallation: (projectId: string, isCondensed: boolean) => (
			<CodeSteps
				steps={[
					{
						text: 'Install the Next SDK',
						code: (
							<CodeBlock
								code="npm install @tunnel/nextjs"
								language="shell"
							/>
						),
					},
					{
						...
						code: (
							<CodeBlock
								code={`import { TunnelToolbar } from "@tunnel/nextjs";\n\nexport default function RootLayout({ children }) {\n  return (\n    <html lang="en">\n      <body>\n        {children}\n        {process.env.APP_ENV === "staging" && (\n          <TunnelToolbar\n            projectId="${projectId}"\n            branch="BRANCH_NAME"\n          />\n        )}\n      </body>\n    </html>\n  );\n}`}
								language="javascript"
								lineNumbers
								isCondensed={isCondensed}
							/>
	...
	other: {
		...
		getHostedInstallation: (projectId: string, isCondensed: boolean) => (
			<CodeSteps
				steps={[
					{
						text: 'Add the Tunnel Toolbar script to your app',
						code: (
							<CodeBlock

...
export function LinearStatusCombobox(
	...
	const response = trpc.linear.getWorkflowStates.useQuery({
		organizationMember: {
	...
	const workflowStates = data?.isOk() ? data.value : [];
		...
		<Popover open={isOpen} onOpenChange={setIsOpen}>
			...
			>
				<Command>
					...
					/>
					<CommandContent isLoading={responseStatus === 'pending'}>
						<CommandEmpty>No status found.</CommandEmpty>
						<CommandGroup>
							{workflowStates.map((filteredStatus) => (
								<CommandItem
